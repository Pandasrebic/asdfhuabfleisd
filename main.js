...
function uploadcar1() {
    ctx.drawImage(car1_imgtag, car1_x, car1_y, car1_width, car1_x);
}
function uploadcar2() {
    ctx.drawImage(car2_imgtag, car2_x, car2_y, car2_width, car2_x);
}
...
{
    console.log("car1 won")
    document.getElementById("game_status").innerHTML = "Status: car1 won";
}

if(car2_x >700)
{
    console.log("car2 won")
    document.getElementById("game_status").innerHTML = "Status: car2 won";
}